    ...
    $("#board div").each(function(){
        ...
        if(isLegalMove(old_x, old_y, $(this).data('x'), $(this).data('y'), pawn, team)){
            ...
            if(checkForEnemyContact($(this).data('x'), $(this).data('y'), team)){
                $(this).prepend('<img class="fightIcon swordLeft" src="./themes/classic/sword_left.png" />');
                $(this).prepend('<img class="fightIcon swordRight" src="./themes/classic/sword_right.png" />');
            }
